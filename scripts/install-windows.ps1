...
Write-Host "  │    ✔ Use the WSL2 based engine                       │" -ForegroundColor Cyan
Write-Host "  │                                                      │" -ForegroundColor Cyan
Write-Host "  │  Settings → Resources → WSL Integration             │" -ForegroundColor Cyan
Write-Host "  │    ✔ Enable integration with your WSL distro        │" -ForegroundColor Cyan
Write-Host "  └─────────────────────────────────────────────────────┘" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "  2. Clone the repository:" -ForegroundColor Gray
Write-Host "       git clone --recurse-submodules https://github.com/Software-Solaris/solaris-software.git" -ForegroundColor White
Write-Host ""
Write-Host "  3. Open it in VS Code:" -ForegroundColor Gray
Write-Host "       code solaris-software" -ForegroundColor White
Write-Host ""
Write-Host "  4. Click 'Reopen in Container' when VS Code prompts." -ForegroundColor Gray
Write-Host "     The first build takes a few minutes." -ForegroundColor Gray
Write-Host ""
Write-Host "  5. Inside the container terminal:" -ForegroundColor Gray

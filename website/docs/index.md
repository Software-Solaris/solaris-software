<img src="assets/logo.png" alt="logo" style="display:block; margin:24px auto 0; width:80px;">

# Solaris (Uvigo Aerotech)


## Welcome to Solaris Software!
...
- Credit must be given to Solaris (UVigo Aerotech), the creator.
...
You can visit our website on the dark web using Tor [here](http://solaris4zr7dayxmm5rflkb4iajrthvdvnmjsmvni4skwufs24x6h3ad.onion/) — you'll need the [Tor Browser](https://www.torproject.org/download/) to open it. We want all the teams and people around the globe to collaborate on our project. Join us to make a better software!
